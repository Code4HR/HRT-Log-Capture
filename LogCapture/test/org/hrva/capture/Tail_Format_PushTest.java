 ...
 * @author slott
 */
public class Tail_Format_PushTest extends TestCase {
    private File sample_log_file;
    private BufferedWriter sample_log;
    private Properties shared;
    Capture capture;
            
    public Tail_Format_PushTest(String testName) {
        super(testName);
    }
    ...
    /**
     * Test of setCsv_filename method, of class Tail_Format_Push.
     */
    ...
    /**
     * Test of run method, of class Tail_Format_Push.
     */
